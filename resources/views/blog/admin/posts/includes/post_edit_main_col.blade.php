        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#maindata" role="tab">Основные данны</a>
                    </li>
                    <li class="nav-item">
...
@endforeach
                    ...
                    <div class="form-group">
                        ...
                        <input name="is_published" type="checkbox" class="form-check-input" value="1"@if($item->published_at)checked="checked"@endif>
